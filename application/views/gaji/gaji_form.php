                    ...
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo site_url('gaji/save/').$this->uri->segment(3); ?>" method="post">
                        <div class="form-group has-feedback">
                            <label for="karyawan_id">Karyawan</label>
                                <input type="text" class="form-control" style="width: 100%;" data-error="Nama Jabatan harus diisi" name="karyawan_id" id="karyawan_id" placeholder="karyawan_id Per Bulan" value="<?php  echo isset($row)?$row->karyawan_id:'' ?>" required />
