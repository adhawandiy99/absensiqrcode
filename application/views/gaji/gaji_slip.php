...
<section class='content'>
    <div>
        <form role="form" id="myForm" action="<?php echo site_url('gaji/printer') ?>" method="post">
            <button type="submit" class="btn btn-info btn-sm mt-2" id="create_pdf" name="gaji_id" value="<?php echo $row->id ?>">Cetak Pdf</button>
        </form>
    </div>
...
<script src="<?php echo base_url() ?>assets/plugins/DoersGuild-jQuery.print/dist/jQuery.print.min.js"></script>
